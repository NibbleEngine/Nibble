...
namespace NbCore.Platform.Windowing
{
    public class NbOpenGLWindow : NbWindow
    {
        ...
        public override NbVector2 MouseScroll
        {
            get
            {
                return new NbVector2(_win.MouseState.Scroll.X, _win.MouseState.Scroll.Y);
            }
        }
        ...
        public override NbVector2 MouseScrollDelta
        {
            get
            {
                return new NbVector2(_win.MouseState.ScrollDelta.X, _win.MouseState.ScrollDelta.Y);
            }
        }
