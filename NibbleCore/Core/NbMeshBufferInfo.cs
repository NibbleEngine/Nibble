namespace NbCore
{
    ...
    {
        [NbSerializable] public NbBufferSemantic semantic;
        ...
        public NbMeshBufferInfo(NbBufferSemantic sem, NbPrimitiveDataType typ, int c, int s, int off, string t, bool n)
        {
            semantic = sem;
            type = typ;
            count = c;
